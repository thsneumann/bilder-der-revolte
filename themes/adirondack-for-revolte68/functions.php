...
function adirondack_scripts() {
	...
	wp_enqueue_style( 'adirondack-fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css' );
	...
	wp_enqueue_script( 'adirondack-custom', get_template_directory_uri() . '/js/custom.js', 'jquery' );
}
...
function adirondack_fonts_url() {
	...
	if ( 'off' !== $mavenpro || 'off' !== $ptserif ) {
		...
		$font_families[] = urlencode( 'Open Sans Condensed:400,700' ); // Add Open Sans Condensed
